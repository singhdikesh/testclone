...
export type StorageHash =
  StorageHashBase<'1a782c9e686a331825378e6ed66f004ebfc40336261c18cb4ef550da712c0f6d'>;
export type ExecutionHash =
  ExecutionHashBase<'f8a4a5d4d8ee06bce37576360f64df41eae265c07e38d702ca415edc08c4dbba'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Message: {
      ...
      readonly type: 'TEXT' | 'IMAGE' | 'VIDEO' | 'FILE';
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly messageMedia: {
              ...
              indexes: readonly [
                {
                  readonly name: 'messageMedia_messageId_idx_3cdded8d';
                  readonly prefix: 'messageMedia_messageId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'messageMedia';
                    readonly columns: readonly ['messageId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly messageRead: {
              ...
              indexes: readonly [
                {
                  readonly name: 'messageRead_userId_idx_a489d58a';
                  readonly prefix: 'messageRead_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'messageRead_messageId_idx_3cdded8d';
                  readonly prefix: 'messageRead_messageId_idx';
                  readonly columns: readonly ['messageId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'messageRead';
                    readonly columns: readonly ['messageId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly postMedia: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'postMedia_userId_idx_a489d58a';
                  readonly prefix: 'postMedia_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly postView: {
              ...
              indexes: readonly [
                {
                  readonly name: 'postView_postId_idx_a7a72715';
                  readonly prefix: 'postView_postId_idx';
                  readonly columns: readonly ['postId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'postView_userId_idx_a489d58a';
                  readonly prefix: 'postView_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
          ...
          readonly valueSet: {
            readonly ConversationMemberRole: {
              readonly kind: 'valueSet';
              readonly values: readonly ['MEMBER', 'ADMIN'];
            };
            ...
            readonly MessageType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['TEXT', 'IMAGE', 'VIDEO', 'FILE'];
            };
...
> & {
  ...
  readonly roots: {
    ...
    readonly postView: { readonly namespace: 'public' & NamespaceId; readonly model: 'PostView' };
    readonly notification: {
      readonly namespace: 'public' & NamespaceId;
