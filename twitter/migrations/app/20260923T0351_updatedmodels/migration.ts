#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/232a74b51a19a5c72e740ea71101564a4820823ec2ee6e1a84cd9440fdc877ca/contract';
import endContract from '../../snapshots/232a74b51a19a5c72e740ea71101564a4820823ec2ee6e1a84cd9440fdc877ca/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  checkExpression,
    ...
    return [
      ...
      this.createTable({
        ...
        constraints: [
          primaryKey(['id']),
          checkExpression(
            'notification_type_check_eeafee12',
            "\"type\" IN ('POST', 'LIKE', 'REPOST', 'FOLLOW', 'REPLY')",
          ),
        ],
      }),
      this.createTable({
      ...
      this.createTable({
        ...
        constraints: [
          primaryKey(['id']),
          checkExpression('postMedia_type_check_c8d14ba3', "\"type\" IN ('IMAGE', 'VIDEO')"),
        ],
      }),
      this.createTable({
        schema: 'public',
      ...
      this.addUnique({
        schema: 'public',
        table: 'postMedia',
        constraint: 'postMedia_postId_userId_key',
      ...
      this.createIndex({
        schema: 'public',
        table: 'postMedia',
        index: 'postMedia_postId_idx_a7a72715',
        columns: ['postId'],
      }),
      this.createIndex({
        schema: 'public',
      ...
      this.createIndex({
        schema: 'public',
        table: 'postView',
        index: 'postView_postId_idx_a7a72715',
        columns: ['postId'],
      }),
      this.createIndex({
        schema: 'public',
        table: 'postView',
        index: 'postView_userId_idx_a489d58a',
        columns: ['userId'],
      }),
      this.createIndex({
        schema: 'public',
